...
13. Search for and add these **core assets** (you can select multiple before clicking **Add**):
...
14. Optionally, add more assets to enrich the data product:
    - **Fabric**: `dimension_city`, `fact_sale` (if available in your Lakehouse)
    - **Databricks**: any additional tables from your custom catalog
15. Verify the assets appear in the data product's asset list (minimum 3 assets)
